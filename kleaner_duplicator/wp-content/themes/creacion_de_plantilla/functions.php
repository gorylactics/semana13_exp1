...
function cargar_estilos(){
  // Que estilos se van a cargar
	...
	wp_enqueue_style('style', get_template_directory_uri() . '/css/style.css', null, '1.0');
...
// wp_enqueue_style('que es lo que se cargara', (desde donde tomara la info )get_template_directory_uri() . '/style.css', null, '1.0');

add_theme_support('post-thumbnails');
add_image_size('avatar' , 300 , 300 , true); //para ajustar el tamaño de todas la imagenes que se suben// con true recorta y con false redimensiona
add_image_size('full' , 300 , 300 , false);
add_image_size('portafolio-thumbnail' , 220 , 180 , true);
add_image_size('portafolio-full' , 1000 , 1000 , false);
add_image_size('slider' , 940, 488 , true);